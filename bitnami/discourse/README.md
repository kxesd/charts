...
| `discourse.maxmind.key`                        | Maxmind license key                                                                                              | `""`                                           |
| `discourse.maxmind.existingSecret`             | Name of an existing Kubernetes secret. The secret must have the following key configured: `maxmind-license-key`  | `""`                                           |
